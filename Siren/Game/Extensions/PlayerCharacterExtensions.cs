...
namespace Siren.Game.Extensions
{
    ...
    public static class PlayerCharacterExtensions
    {
        ...
        public static GameObject? ToDalamudGameObject(this PlayerCharacter pc)
            => SharedServices.ObjectTable.CreateObjectReference(pc.Address);

        /// <summary>
        ///     Creates a <see cref="FFXIVClientStructs.FFXIV.Client.Game.Object.GameObject" /> from the
        ///     <see cref="PlayerCharacter" /> address.
        /// </summary>
        /// <param name="pc"></param>
        /// <returns></returns>
